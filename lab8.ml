...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let answer = new_id () in
    evt := !evt @ [{id = answer; action = listener}];
    answer ;;
...
let receive_report (x : string) : unit =
  let _ = WEvent.add_listener publish (fun () -> fakeNewsNetwork x) in
  let _ = WEvent.add_listener publish (fun () -> buzzFake x) in () ;;
